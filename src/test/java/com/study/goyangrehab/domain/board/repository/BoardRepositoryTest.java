...
class BoardRepositoryTest {
    ...
    void queryDslTest(){
        ...
        List<Board> results = boardRepository.findQnAWithReply(PageRequest.of(1,10));
        // then

        results.forEach(result -> {
            assertThat(result.getTitle()).isEqualTo(expectedResult.get(results.indexOf(result)).getTitle());
        } );
